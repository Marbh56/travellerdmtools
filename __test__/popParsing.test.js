...
test("popParsing 6", () => {
  ...
  const actual = popParsing(input);
  const expected = "Pop: 1,000,000";
  expect(actual).toEqual(expected);
});
test("popParsing 7", () => {
  const input = "11117111";
  const actual = popParsing(input);
  const expected = "Pop: 10,000,000";
  expect(actual).toEqual(expected);
});
...
test("popParsing 8", () => {
  ...
  const actual = popParsing(input);
  const expected = "Pop: 100,000,000";
  expect(actual).toEqual(expected);
});
...
test("popParsing 9", () => {
  ...
  const actual = popParsing(input);
  const expected = "Pop: 1,000,000,000";
  expect(actual).toEqual(expected);
});
...
test("popParsing A", () => {
  ...
  const actual = popParsing(input);
  const expected = "Pop: 10,000,000,000";
  expect(actual).toEqual(expected);
});
...
test("popParsing B", () => {
  ...
  const actual = popParsing(input);
  const expected = "Pop: 100,000,000,000";
  expect(actual).toEqual(expected);
});
...
test("popParsing C", () => {
  ...
  const actual = popParsing(input);
  const expected = "Pop: 1,000,000,000,000";
  expect(actual).toEqual(expected);
});
...
test("popParsing D", () => {
  ...
  const actual = popParsing(input);
  const expected = "Pop: 10,000,000,000,000";
  expect(actual).toEqual(expected);
});
...
test("popParsing E", () => {
  ...
  const actual = popParsing(input);
  const expected = "Pop: 100,000,000,000,000";
  expect(actual).toEqual(expected);
});
...
test("popParsing Hex", () => {
  ...
  const actual = popParsing(input);
  const expected = "Pop: 1,000,000,000,000,000";
  expect(actual).toEqual(expected);
});
